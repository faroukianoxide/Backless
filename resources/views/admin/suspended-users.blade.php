...
@section('right-panel')
<div class="main text-cdenter">

    <div class="card-header">
        <strong class="card-title">Suspended Users</strong>
    </div>
            ...
            <tbody>
                ...
                <!--issue: dont forget to always give notification of any actions performed -->
                    ...
                    <tr class="table-row sortable" style = "cursor: pointer;" title = {{$user->name}}
                        onclick="window.location = '/admin/users/suspended/{{$user->id}}' "> <!-- issue change this to html code and not javascript -->
